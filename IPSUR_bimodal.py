...
load_path = './Ressources/Bimodal_case/'
...
sampler_inf = NUTS_Bimodal(gp_infinite, np.ravel(observations), cov_obs_tot, bounds_mcmc)
...
sampler_sur = NUTS_Bimodal(gp_sur, np.ravel(observations), cov_obs_tot, bounds_mcmc)
sampler_csq = NUTS_Bimodal(gp_csq, np.ravel(observations), cov_obs_tot, bounds_mcmc)
sampler_naive = NUTS_Bimodal(gp_naive, np.ravel(observations), cov_obs_tot, bounds_mcmc)
sampler_sinsbeck = NUTS_Bimodal(gp_sinsbeck, np.ravel(observations), cov_obs_tot, bounds_mcmc)
